    ...
    <Carousel.Caption>
      ...
      <p>Praesent commodo cursus magna, vel scelerisque nisl consectetur.</p>
        ...
        {this.state.ai.map((obj)=>{
          return(
        <Card style={{textAlign: 'center', width: '300px', height: '300px',paddingLeft: '20px',marginLeft: '20px',marginRight:'20px',marginBottom: '20px'}}>
    
        <div> 
        <Link to={`/productDescription/${obj._id}` }>
        <img src={obj.screenShot} alt="ai" weight="300px" height="100px"/>
        </Link>
              <p> {obj.pname} </p>
              <p> {obj.category} </p>
